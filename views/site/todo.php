...
<div class="site-index">
    ...
    <div class="body-content">
        ...
        <div id="synchronizedLabel" class="alert alert-success alert-dismissable" style="display:none;"><button type="button" class="close" aria-hidden="true">&times;</button><strong>Connection resumed.</strong> All your changes <strong>synchronized</strong></div>
